...
class CouponModel {
  ...
  // Convert List<Document> to List<CouponModel>
  static List<CouponModel> fromJsonList(List<Document> list) {
    return list.map((e) => CouponModel.fromJson(e.data, e.$id)).toList();
  }
}
